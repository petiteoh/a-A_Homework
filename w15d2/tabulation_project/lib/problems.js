...
//         let adjacentAdd = table[i - 2] === undefined ? 0 : table[i - 2];
//         let addCurrNum = adjacentAdd + nums[i];
//         let notAdjacentAdd = table[i - 1];
//         table[i] = Math.max(addCurrNum, notAdjacentAdd);
//     }
